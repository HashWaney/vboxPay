...
import com.hash.lib.ui.recyclerview.animation.AlphaInAnimation;
import com.hash.lib.ui.recyclerview.animation.BaseAnimation;
import com.hash.lib.ui.recyclerview.animation.ScaleInAnimation;
import com.hash.lib.ui.recyclerview.animation.SlideInBottomAnimation;
import com.hash.lib.ui.recyclerview.animation.SlideInLeftAnimation;
import com.hash.lib.ui.recyclerview.animation.SlideInRightAnimation;
import com.hash.lib.ui.recyclerview.entity.IExpandable;
import com.hash.lib.ui.recyclerview.loadmore.LoadMoreView;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     * @param isHeadAndEmpty
     */
    public void setHeaderEmpty(boolean isHeadAndEmpty) {
        mHeadAndEmptyEnable = isHeadAndEmpty;
    }
    ...
    public View getItemViewByPosition(int position) {
        checkNotNull();
        BaseViewHolder viewHolder = (BaseViewHolder) getRecyclerView().findViewHolderForLayoutPosition(position);
