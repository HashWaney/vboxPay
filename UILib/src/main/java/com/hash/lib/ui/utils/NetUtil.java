...
public class NetUtil {
    ...
    private static ConnectivityManager getConnectivityManager() {
        if (sConnectivityManager == null) {
            synchronized (NetUtil.class) {
                if (sConnectivityManager == null)
                    sConnectivityManager = (ConnectivityManager) sApplication.getBaseContext().getSystemService(Context
    ...
    private static void openSetting(String actionName) {
        try {
            ...
            sApplication.getApplicationContext().startActivity(settingIntent);
        } catch (Throwable e) {
    ...
    public static boolean isNetworkAvailable(NetType netType) {
        ...
        return isConnected(netType, networkInfo);
    }
