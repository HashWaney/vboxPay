...
public abstract class BaseRecyclerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>{
    ...
    /** 数据集合 */
    protected ArrayList<T> mItemLists = new ArrayList();
    ...
    public BaseRecyclerAdapter(Context mContext, ArrayList<T> mItemLists) {
        this(mContext,mItemLists,null);
    }

    public BaseRecyclerAdapter(Context mContext, ArrayList<T> mItemLists, RecyclerView recyclerView) {
    ...
    public interface OnRecyclerViewItemClickListener{   //点击事件接口

        public void onItemClick(View view, int position);
    }

    public OnRecyclerViewItemClickListener mOnRecyclerViewItemClickListener=null;   //列表项的点击事件回调接口
    ...
    public interface OnRecyclerViewItemLongClickListener{   //长按事件接口

        public boolean onItemLongClick(View view, int position);
    }

    public OnRecyclerViewItemLongClickListener mOnRecyclerViewItemLongClickListener=null;   //列表项长按事件回调接口

    public void setOnRecyclerViewItemLongClickListener(OnRecyclerViewItemLongClickListener onItemLongClickListener){
        this.mOnRecyclerViewItemLongClickListener=onItemLongClickListener;
    }
}
