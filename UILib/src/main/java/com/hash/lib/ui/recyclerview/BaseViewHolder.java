...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public BaseViewHolder setEmptyCompoundDrawablesWithIntrinsicBounds(int viewId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public BaseViewHolder setLeftCompoundDrawablesWithIntrinsicBounds(int viewId, int leftResId) {
        TextView view = getView(viewId);
        view.setCompoundDrawablesWithIntrinsicBounds(leftResId, 0, 0, 0);
        return this;
    }
     ...
     * @return
     */
    public BaseViewHolder setRightCompoundDrawablesWithIntrinsicBounds(int viewId, int rightResId) {
        TextView view = getView(viewId);
        view.setCompoundDrawablesWithIntrinsicBounds(0, 0, rightResId, 0);
        return this;
    }
