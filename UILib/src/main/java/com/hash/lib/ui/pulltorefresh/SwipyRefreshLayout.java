...
public class SwipyRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    public void setProgressViewStartOffset(int originalOffsetTop){
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2,true);
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(SwipyRefreshLayout parent, @Nullable View child);
    }
